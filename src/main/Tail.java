...
/**
* La clase {@code Tail} implementa una aplicación simple para imprimir las últimas {@code n} líneas de un archivo.
...
public class Tail {
	...
	* </pre>
	* <ul>
	* 	<li>Al ejecutar <pre>java main.Tail lineas.txt 4</pre>, se debe imprimir el archivo completo.</li>
	* 	<li>Al ejecutar <pre>java main.Tail lineas.txt 2</pre>, se debe imprimir
	*		<pre>
	*			linea2
	*			linea3
	*		</pre>.
	*	</li>
	* 	<li>Al ejecutar <pre>java main.Tail lineas.txt 0</pre>, no se debe imprimir nada</li>
	* </ul>
	...
	*/
	...
	private static void mostrarUso() {
		String uso = 	"Tail\n" +
				...
				"Uso:\n" +
				"java main.Tail --ayuda					:	muestra este mensaje.\n" +
				"java main.Tail <ruta a un archivo> <entero mayor a 0>	:	imprime las últimas n de un archivo.\n"
		;
