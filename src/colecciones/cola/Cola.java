...
/**
* La interface {@code Cola} representa una cola de objetos <b>first in first out (FIFO)</b> donde el primer elemento insertado es el primero que se accede.
...
* </ul>
* @param T : el tipo de los elementos a almacenar en la Cola.
* @version 1.1
*/
